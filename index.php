<html>
    ...
    <body background="/images/fon.jpg">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            Имя:<input type="Text" name="name" size="20" placeholder="Ваше имя" maxlength="30" minlength="5" value="<?php echo $name; ?>"> 
            <span class="error">* <?php
                if (!empty($nameErr)) {
                echo $nameErr;
                }
                ?></span><br><br>
            <textarea type="Text" name="text" rows="10" cols="70" placeholder="Ваш комментарий" maxlength="750" minlength="10" value="<?php echo $text; ?>"><?php echo $text; ?></textarea>
            <span class="error">* <?php
                if (!empty($textErr)) {
                echo $textErr;
                }
